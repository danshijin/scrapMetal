var Layout = function () {
    ...
    return {
        ...
        initHeader: function() {
            ...
            loginInfo();
//            chatsNotice();
            if($("#strongMsgNum").text() > 0) {
				$("#chatRemindImg").attr("src",BASE_URL + "/Public/images/chats/chatRemindBlink.gif");
			} else {
				$("#chatRemindImg").attr("src",BASE_URL +  "/Public/images/chats/msgRemind.png");
			}
        },
